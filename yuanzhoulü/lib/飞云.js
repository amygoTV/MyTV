var rule = {
    ...
    class_name:'电影&连续剧&动漫&综艺&少儿',
    class_url:'1&2&4&3&5',
    play_parse: true,
    lazy:'js:if(/m3u8|mp4/.test(input)){input}else{let purl=request("http://122.228.84.103:7777/api/?key=XX84Rm4utDcfLT21tT&url="+input);input={jx:0,url:JSON.parse(purl).url,parse:0}}',
    limit:6,
